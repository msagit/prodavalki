...
<?=Html::beginForm(['parcel/addbulk'],'post');?>
    <p>
        <!--<?php/* Html::a('Create Order', ['create'], ['class' => 'btn btn-success']) */?>-->
        <?=Html::submitButton('Add to parcel', ['class' => 'btn btn-info',]);?>
    </p>
    <?= GridView::widget([
...
[
    ...
    'width' => '8%',
//k    'filterType' => GridView::FILTER_COLOR,
    'filterWidgetOptions' => [
        'showDefaultPalette' => false,
        'pluginOptions' => $colorPluginOptions,
    ],
...
//k    'filterType' => GridView::FILTER_SELECT2,
//k    'filter' => ArrayHelper::map(Author::find()->orderBy('name')->asArray()->all(), 'id', 'name'), 
    'filterWidgetOptions' => [
...
[
    ...
    'editableOptions' => [
        'header' => 'Publish Date', 
        'size' => 'md',
        //k 'inputType' => \kartik\editable\Editable::INPUT_WIDGET,
        'widgetClass' =>  'kartik\datecontrol\DateControl',
        'options' => [
            //k 'type' => \kartik\datecontrol\DateControl::FORMAT_DATE,
...
[
    ...
    'editableOptions' => [
        'header' => 'Buy Amount', 
//k        'inputType' => \kartik\editable\Editable::INPUT_SPIN,
        'options' => [
...
[
    ...
    'mergeHeader' => true,
    'pageSummary' => true,
//k    'pageSummaryFunc' => GridView::F_AVG,
    'footer' => true
],
[
...
//k    'containerOptions' => ['style' => 'overflow: auto'], // only set when $responsive = false
...
//    'pjax' => true, // pjax is set to always true for this demo
    ...
    'toolbar' =>  [
        ['content' => 
//k            Html::button('<i class="glyphicon glyphicon-plus"></i>', ['type' => 'button', 'title' => Yii::t('kvgrid', 'Add Book'), 'class' => 'btn btn-success', 'onclick' => 'alert("This will launch the book creation form.\n\nDisabled for this demo!");']) . ' '.
            Html::button('<i class="glyphicon glyphicon-plus"></i>', ['type' => 'button', 'title' => 'Add Book', 'class' => 'btn btn-success', 'onclick' => 'alert("This will launch the book creation form.\n\nDisabled for this demo!");']) . ' '.
//k            Html::a('<i class="glyphicon glyphicon-repeat"></i>', ['grid-demo'], ['data-pjax' => 0, 'class' => 'btn btn-default', 'title' => Yii::t('kvgrid', 'Reset Grid')])
